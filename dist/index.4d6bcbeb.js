...
})({"crIhb":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
$button1.on("click", ()=>{
    ...
    n1 += 1;
    localStorage.setItem("n", n1); //每次改变后的n都存到localStorage中
    $number.text(n1); //把 +1 过的 n 放回去
});
$button2.on("click", ()=>{
    let n2 = parseInt($number.text());
    n2 -= 1;
    localStorage.setItem("n", n2);
    $number.text(n2); //把 -1 过的 n 放回去
});
$button3.on("click", ()=>{
    let n3 = parseInt($number.text());
    n3 *= 2;
    localStorage.setItem("n", n3);
    $number.text(n3); //把 *2 过的 n 放回去
});
$button4.on("click", ()=>{
    let n4 = parseInt($number.text());
    n4 /= 2;
    localStorage.setItem("n", n4);
    $number.text(n4); //把 /2 过的 n 放回去
});

},{"jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"daEAq","./app1.css":"7FkZd"}],"hgMhh":[function(require,module,exports) {
/*!
...
},{}],"daEAq":[function(require,module,exports) {
...
$tabBar.on("click", "li", (e)=>{
    ...
    console.log(index);
    $tabContent.children() //找到tabContent的儿子们
    .eq(index).addClass("active") //第index个增加active类
...
},{"jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"daEAq","./app2.css":"8RnuD"}],"8RnuD":[function() {},{}],"264pe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./app3.css":"iOgrn","jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"daEAq"}],"iOgrn":[function() {},{}],"6ZENx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"daEAq","./app4.css":"jZ1KW"}],"jZ1KW":[function() {},{}]},["crIhb","gLLPy"], "gLLPy", "parcelRequire42e6")
